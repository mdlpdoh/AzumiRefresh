...
public static class DebugDraw {
	...
	public static void DrawQuadPoly(Transform[] points, Color color, float duration, bool depthTest = true) 
	{
		...
		if (points.Length == 4 ) {
			...
			{
				//Debug.Log (points[i]);
				Debug.DrawLine(points[i].position, points[i+1].position, color, duration, depthTest);
			}
			Debug.DrawLine(points[points.Length -1].position, points[0].position, color, duration, depthTest);
			Debug.DrawLine(points[0].position, points[2].position, color, duration, depthTest);
			Debug.DrawLine(points[1].position, points[3].position, color, duration, depthTest);
		}
