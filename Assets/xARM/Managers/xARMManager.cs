...
public static class xARMManager {
	...
	private static void InitAvailScreenCaps(){
		...
		addOrUpdateScreenCap (new xARMScreenCap("iPad", 		new Vector2(2048, 1536), "QXGA","", 		9.7f, 264, "@2x", 		xARMScreenCapGroup.iOS, 4, 16.1f, "iPad 3., 4., Air, Air 2"));
		addOrUpdateScreenCap (new xARMScreenCap("iPad mini", 	new Vector2(2048, 1536), "QXGA","", 		7.9f, 326, "@2x", 		xARMScreenCapGroup.iOS, 4, 16.1f, "iPad mini 2, mini 3"));
		...
		addOrUpdateScreenCap (new xARMScreenCap("iPhone", 		new Vector2(1920, 1080), "FHD", "", 		5.5f, 401, "@2.6x",		xARMScreenCapGroup.iOS, 999, -1f, "iPhone 6 Plus (Unity uses native resolution)"));
		...
		addOrUpdateScreenCap (new xARMScreenCap("", new Vector2(1920, 1080), "FHD","", 		5.0f, 0, "", 	xARMScreenCapGroup.Android,  3,10.7f, "Nexus 5 (4.96), Galaxy S5 (5.1), S4 (5), ..."));
		...
		addOrUpdateScreenCap (new xARMScreenCap("", new Vector2(2560, 1440), "QHD","",	   6.0f, 0, "", 	xARMScreenCapGroup.Android, 999, -1f, "Nexus 6 (5.96), Galaxy Note 4 (5.7)..."));
	...
	public static void UpdateGameView(){
		...
		GameView.Focus ();
		xARMManager.skipNextUpdate = true;
	}
